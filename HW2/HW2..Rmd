...
dat <-  read_csv("data/contraceptive_use-1.csv")
```
...
[link][https://github.com/JouiniOm/BIOSTATS-632]

Sorry had a medical emergency in the neighbourhood, I couldn't work anymore on it and now it is pretty late.
